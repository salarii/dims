...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        spendZeroConfChangeInfoLabel->setObjectName(QStringLiteral("spendZeroConfChangeInfoLabel"));
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        threadsScriptVerif->setToolTip(QApplication::translate("OptionsDialog", "Set the number of script verification threads (up to 16, 0 = auto, <0 = leave that many cores free, default: 0)", 0));
#endif // QT_NO_TOOLTIP
        ...
        spendZeroConfChangeInfoLabel->setText(QApplication::translate("OptionsDialog", "If you disable the spending of unconfirmed change, the change from a transaction cannot be used until that transaction has at least one confirmation. This also affects how your balance is computed.", 0));
