...
typedef boost::mpl::list< common::CMediumException, CDummyResponse, common::CIdentificationResult, common::CAckPromptResult, common::CConnectedNode, common::CAckResult, common::CMessageResult, common::CNoMedium > MonitorResponseList;
