...
typedef boost::variant< common::CDummy, common::CAvailableCoins, common::CClientNetworkInfoResult, common::CTransactionAck, common::CTrackerSpecificStats > ClientResponse;
