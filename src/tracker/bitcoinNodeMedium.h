...
public:
	...
	bool getResponseAndClear( std::multimap< common::CRequest< TrackerResponses >const*, TrackerResponses > & _requestResponse );
...
private:
	...
	std::multimap< common::CRequest< TrackerResponses >const*, TrackerResponses > m_responses;
