...
public:
	...
	bool getResponseAndClear( std::multimap< common::CRequest< _Type >const*, TrackerResponses > & _requestResponse );
...
private:
	...
	std::multimap< common::CRequest< _Type >const*, TrackerResponses > m_responses;
