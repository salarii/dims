...
cd /c/msys/1.0/home/Artur/bitcoin-master
make distdir
mkdir -p win32-build
...
if [ -d "$OUT_DIR" -a -w "$OUT_DIR" ]; then
  set +e
  # Windows:
  cp /c/msys/1.0/home/Artur/bitcoin-master/win32-build/src/bitcoind.exe $OUT_DIR/bitcoind.exe
  cp /c/msys/1.0/home/Artur/bitcoin-master/win32-build/src/test/test_bitcoin.exe $OUT_DIR/test_bitcoin.exe
  cp /c/msys/1.0/home/Artur/bitcoin-master/win32-build/src/qt/bitcoind-qt.exe $OUT_DIR/bitcoin-qt.exe
  # Linux:
  cp /c/msys/1.0/home/Artur/bitcoin-master/linux-build/src/bitcoind $OUT_DIR/bitcoind
  cp /c/msys/1.0/home/Artur/bitcoin-master/linux-build/src/test/test_bitcoin $OUT_DIR/test_bitcoin
  cp /c/msys/1.0/home/Artur/bitcoin-master/linux-build/src/qt/bitcoind-qt $OUT_DIR/bitcoin-qt
  set -e
fi

# Run unit tests and blockchain-tester on Linux:
cd /c/msys/1.0/home/Artur/bitcoin-master/linux-build
make check

# Run RPC integration test on Linux:
/c/msys/1.0/home/Artur/bitcoin-master/qa/rpc-tests/wallet.sh /c/msys/1.0/home/Artur/bitcoin-master/linux-build/src

if [ $RUN_EXPENSIVE_TESTS = 1 ]; then
  # Run unit tests and blockchain-tester on Windows:
  cd /c/msys/1.0/home/Artur/bitcoin-master/win32-build
  make check
fi
